...
asset::TypedAssetPath<asset::Texture> ui::ASSET_IMG_SLOT = asset::TypedAssetPath<asset::Texture>::Create(
	"assets/textures/ui/slot.te-asset"
);
ui::Image& ui::createSlotImage(ui::Image& img, ui32 borderWidthInPoints)
{
	auto asset = ui::ASSET_IMG_SLOT.load(asset::EAssetSerialization::Binary);
