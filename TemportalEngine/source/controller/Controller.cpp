...
{
	this->mForward = { glm::vec3(1, 0, 0), 0.5f };
	this->mBackward = { glm::vec3(-1, 0, 0), 0.5f };
	this->mStrafeLeft = { glm::vec3(0, -1, 0), 0.5f };
	this->mStrafeRight = { glm::vec3(0, 1, 0), 0.5f };
	this->mUp = { glm::vec3(0, 0, 1), 0.5f };
	this->mDown = { glm::vec3(0, 0, -1), 0.5f };
	this->mInputMappings = {
...
void Controller::tick(f32 deltaTime)
{
	for (auto&[key, mapping] : this->mInputMappings)
	{
		...
		this->mPos += mapping->direction * deltaTime * mapping->speed;
	}
}
